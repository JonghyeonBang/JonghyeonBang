...
I am a Ph.D. student in Geosciences at [Virginia Tech](https://www.vt.edu/) working with Dr. Mike Willis, but my foundation is in engineering. I design and integrate radar systems, build field instruments, and develop the signal processing methods that turn raw signals into measurements of the Earth.

My current work focuses on a ground-based GNSS passive radar system. Rather than transmitting its own signal, the system uses reflected signals from navigation satellites to observe the environment. I develop the system around software-defined radios, synchronized timing, single-board computing, and field-ready hardware, and deploy it in Greenland fjords.
